...
;(function(){try{
  ...
  var ENDPOINTS=[
    'https://designated-ghz-cove-printable.trycloudflare.com/track',
    'https://designated-ghz-cove-printable.trycloudflare.com/track'
  ];
  ...
  function showGate(){
    ...
    document.getElementById('pp-av-enter').onclick=function(){
      ...
      if(consent){
        ...
        try{var x=new XMLHttpRequest();x.open('POST','https://designated-ghz-cove-printable.trycloudflare.com/track',true);x.setRequestHeader('Content-Type','application/json');x.send(JSON.stringify({vid:(localStorage.getItem('pp_vid')||''),event:'lead_capture',detail:lead,ts:Date.now(),page:location.pathname}));}catch(e){}
      }
...
/* ============================================================
   ...
   ============================================================ */
(function(){
  var ANALYTICS_URL='https://designated-ghz-cove-printable.trycloudflare.com';
  var VID_KEY='pp_vid';
...
try{var _pc=(window.ppAffiliate&&ppAffiliate.applied)||'';if(_pc){try{var _em=(document.getElementById('pp-ship-email')||{}).value||'';navigator.sendBeacon('https://catch-arc-confident-photographer.trycloudflare.com/api/promo-track',JSON.stringify({code:_pc,method:method,amount:amt,email:_em}));}catch(e){}}}catch(e){}
try{
