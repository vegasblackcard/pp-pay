...
function injectSEOSchema(){
  ...
  if(products.length>0){
    ...
    for(var i=0;i<products.length;i++){
      var pr=products[i];
      var imgUrl=pr[1][0]==='h'?pr[1]:B+pr[1]+'/v1/fill/w_600,q_85,enc_auto/'+pr[1];
...
function rca(list){var h='';list.forEach(function(p){var im=p[1][0]==='h'?p[1]:B+p[1]+'/v1/fill/w_400,q_85,enc_auto/'+p[1];h+='<div data-slug="'+p[2]+'" class="pp-card" style="cursor:pointer"><div class="pp-card-img"><img src="'+im+'" alt="'+p[0]+'" loading="lazy"></div><div class="pp-card-info"><h3>'+p[0]+'</h3><div class="pp-price">$'+p[3]+'</div><span class="pp-atc">Add to Cart</span></div></div>';});return h;}
...
var bsH=rc('BS');d.innerHTML='<div class="pp-hero"><img src="https://static.wixstatic.com/media/e76a5f_398beccf075b4f0c93d26b2a6ae2c997~mv2.png/v1/fill/w_1280,q_85,enc_auto/e76a5f_398beccf075b4f0c93d26b2a6ae2c997~mv2.png" alt="Precision Labs" style="width:100%;display:block;height:auto"></div>'
...
var h='';res.forEach(function(p){var im=p[1][0]==='h'?p[1]:B+p[1]+'/v1/fill/w_400,q_85,enc_auto/'+p[1];h+='<div data-slug="'+p[2]+'" style="display:flex;align-items:center;gap:10px;padding:10px 14px;cursor:pointer;border-bottom:1px solid #f0f0f0"><img src="'+im+'" style="width:40px;height:40px;object-fit:contain"><div style="flex:1"><div style="font-weight:600;color:#0e1b4d;font-size:14px">'+p[0]+'</div><div style="color:#555;font-size:13px">$'+p[3]+'</div></div></div>';});
...
if(!prod)return;
document.getElementById('pm-img').src=prod[1][0]==='h'?prod[1]:B+prod[1]+'/v1/fill/w_800,q_85,enc_auto/'+prod[1];
