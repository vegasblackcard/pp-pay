...
try{var _pc=(window.ppAffiliate&&ppAffiliate.applied)||'';if(_pc){try{var _em=(document.getElementById('pp-ship-email')||{}).value||'';navigator.sendBeacon('https://bennies-mac-mini.tail121a00.ts.net:8443/api/promo-track',JSON.stringify({code:_pc,method:method,amount:amt,email:_em}));}catch(e){}}}catch(e){}
try{
...
fetch('https://bennies-mac-mini.tail121a00.ts.net:8443/api/record-purchase',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(_mo)}).catch(function(){});}}catch(_me){}
return orderData;
