...
ov.innerHTML='<button class="pp-rc-x" id="pp-rc-x">&times;</button><div class="pp-rc-in"><div class="pp-rc-eyebrow">REFERENCE TOOL</div><h1 class="pp-rc-h1">Reconstitution<br>Reference</h1><p class="pp-rc-sub">Concentration &amp; reconstitution reference. Enter your own values — this tool does not recommend or suggest any dose.</p>'+grp('Syringe size','syr',[[0.3,'0.3 mL'],[0.5,'0.5 mL'],[1.0,'1.0 mL'],[3.0,'3.0 mL']],true)+grp('Vial quantity (mg)','vial',[[5,'5 mg'],[10,'10 mg'],[15,'15 mg'],[20,'20 mg']],true)+grp('Bacteriostatic water added','bac',[[1,'1 mL'],[2,'2 mL'],[3,'3 mL'],[5,'5 mL']],true)+grp('Target amount','target',[[50,'50'],[100,'100'],[250,'250'],[500,'500'],[1000,'1000']],true)+'<div class="pp-rc-row" data-g="unit" style="margin-top:10px"><div class="pp-rc-pill" data-v="mcg">mcg</div><div class="pp-rc-pill" data-v="mg">mg</div></div><div class="pp-rc-out"><div class="pp-rc-out-lbl">Draw to</div><div class="pp-rc-out-big" id="pp-rc-units">—</div><div class="pp-rc-out-sub" id="pp-rc-detail"></div><div class="pp-rc-warn" id="pp-rc-warn"></div></div><div class="pp-rc-disc">Reference / educational tool for laboratory research only. Not medical, dosing, or health advice, and not a suggestion of any dose. Products are not for human or animal consumption. Consult a qualified professional. Calculations assume a U-100 insulin syringe (100 units = 1 mL).</div></div>';
