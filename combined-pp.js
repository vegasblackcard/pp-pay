...
["Research Starter Kit","e76a5f_f10806556f8e4e2e821e5d863329b0b0~mv2.png","research-starter-kit",20],
...
try{var _pc=(window.ppAffiliate&&ppAffiliate.applied)||'';if(_pc){try{var _em=(document.getElementById('pp-ship-email')||{}).value||'';navigator.sendBeacon('https://carey-vaccine-promotion-healthcare.trycloudflare.com/api/promo-track',JSON.stringify({code:_pc,method:method,amount:amt,email:_em}));}catch(e){}}}catch(e){}
try{
