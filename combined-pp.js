...
function rca(list){var h='';list.forEach(function(p){var im=p[1][0]==='h'?p[1]:B+p[1]+'/v1/fit/w_400,h_400,q_85,enc_auto/'+p[1];h+='<div data-slug="'+p[2]+'" class="pp-card" style="cursor:pointer"><div class="pp-card-img"><img src="'+im+'" alt="'+p[0]+'" loading="lazy"></div><div class="pp-card-info"><h3>'+p[0]+'</h3><div class="pp-price">$'+p[3]+'</div><span class="pp-atc">Add to Cart</span></div></div>';});return h;}
...
var bsH=rc('BS');d.innerHTML='<div class="pp-hero"><img src="https://static.wixstatic.com/media/e76a5f_398beccf075b4f0c93d26b2a6ae2c997~mv2.png/v1/fit/w_1280,h_720,q_85,enc_auto/e76a5f_398beccf075b4f0c93d26b2a6ae2c997~mv2.png" alt="Precision Labs" style="width:100%;display:block;height:auto"></div>'
