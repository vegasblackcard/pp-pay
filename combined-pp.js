...
["AOD-9604 10mg","e76a5f_bbb4397bfcf44daf807594aa889c5d7d~mv2.png","aod-9604-10mg",180],
...
["BPC-157 10mg","e76a5f_904263486d0f4d6d9067a0700b19fd3d~mv2.png","bpc-157-10mg",80],
...
["CJC-1295 / Ipamorelin 5mg/5mg","e76a5f_76d7f3065828407c97262052bfc5b827~mv2.png","cjc-1295-ipamorelin-5mg5mg",85],
["Cagrilintide 10mg","e76a5f_f1cae1825e6a49ea863c241cef1e8fe6~mv2.png","cagrilintide-10mg",150],
["DSIP (Delta Sleep-Inducing Peptide) 10mg","e76a5f_3433207954004b75993a458fe1d24ba2~mv2.png","dsip-delta-sleep-inducing-peptide-10mg",75],
...
["DSIP (Delta Sleep-Inducing Peptide) 5mg","e76a5f_239158ba6657427e93914f6974c1b0b0~mv2.png","dsip-delta-sleep-inducing-peptide-5mg",65],
["Diabetes Research Stack","e76a5f_6b92f85bf93d4b068e6386544c3f8885~mv2.png","diabetes-research-stack",405],
["Epitalon 10mg","e76a5f_686b0dce263147c881bb7936fc28004c~mv2.png","epitalon-10mg",50],
...
["GHK-Cu (Copper) 100mg","e76a5f_7f727786e85e4256abc4dec8f97ba464~mv2.png","ghk-cu-copper-100mg",120],
["GHK-Cu (Copper) 50mg","e76a5f_56f3237ad9cf4e22b30740465fc86f8e~mv2.png","ghk-cu-copper-50mg",75],
["Glow Stack 70mg","e76a5f_1e6ed4b9ee614cd09e67a970e7c389d4~mv2.png","glow-stack-70mg",160],
["Glutathione 1500mg","e76a5f_36b1485f7d57497892927183fd29c2b8~mv2.png","glutathione-1500mg",110],
...
["IGF-1LR3 1mg","e76a5f_ebc24498572045338fb6d1c64961b443~mv2.png","igf-1lr3-1mg",110],
["Ipamorelin 10mg","e76a5f_8634247ec43a42e4b6b6de3325be680d~mv2.png","ipamorelin-10mg",90],
["Ipamorelin 5mg","e76a5f_ac5775c4b2a84ad1bdcaae6937281131~mv2.png","ipamorelin-5mg",65],
["KLOW 80mg","e76a5f_9a50aecd3a1145fb9cd681e18b7314b8~mv2.png","klow-80mg",180],
["KPV 10mg","e76a5f_8a59d928dc0c45cebb463052e06747dd~mv2.png","kpv-10mg",110],
["Kisspeptin 10mg","e76a5f_560cf72f9c0f4afebd0e12678b9e25d5~mv2.png","kisspeptin-10mg",95],
...
["MOTS-C 10mg","e76a5f_fc7adcb547634bf6bb55afb48029db51~mv2.png","mots-c-10mg",90],
["MOTS-C 40mg","e76a5f_9162cdbf9f014c4d8e27b1ee83896778~mv2.png","mots-c-40mg",180],
["Melanotan I 10mg","e76a5f_bdbbe64243834873a63007f19ad7f6cc~mv2.png","melanotan-i-10mg",60],
["Melanotan II 10mg","e76a5f_cbe66dc973cd453190f710502caeca34~mv2.png","melanotan-ii-10mg",60],
["MetaLean+ G3 4ct Mint","e76a5f_0007573f586043f9b538e86bdef56920~mv2.png","metalean-g3-4ct-mint",249.99],
["NAD+ 500mg","e76a5f_933f1d4e426d4539b18a2688a4e29c70~mv2.png","nad-500mg",120],
["NAD+ Recharge 30ct Mint","e76a5f_33bc93da0ff54726940093c2d0beb37e~mv2.png","nad-recharge-30ct-mint",199.99],
["Oxytocin Acetate 5mg","e76a5f_26979fb67d9b42b991257dab3795ffc5~mv2.png","oxytocin-acetate-5mg",70],
...
["Retatrutide 10mg","e76a5f_125227f9b07c4f18976a60ed7f8cd28b~mv2.png","retatrutide-10mg",300],
["Retatrutide 30mg","e76a5f_8b4dc8f8e44747d5b247d1e3f4f33e9b~mv2.png","retatrutide-30mg",500],
...
["SS-31 (Elamipretide) 50mg","e76a5f_720fa4fb63974d5e8f903cdd47c8104c~mv2.png","ss-31-elamipretide-50mg",195],
["Selank 10mg","e76a5f_c3bdfdaa84ac4cbba5755045c46fbdf6~mv2.png","selank-10mg",80],
["Semaglutide 30mg","e76a5f_e25b132c17c14890b6a0ed03730bdfd4~mv2.png","semaglutide-30mg",500],
["Semaglutide 5mg","e76a5f_dbe8aab004b64c229f4700971ccce977~mv2.png","semaglutide-5mg",250],
["Semax 10mg","e76a5f_1c81441e745b42088dce24fb71cf74af~mv2.png","semax-10mg",80],
["Sermorelin 10mg","e76a5f_8824a216f4dd42b4931488d91db01902~mv2.png","sermorelin-10mg",120],
["Sermorelin 5mg","e76a5f_8824a216f4dd42b4931488d91db01902~mv2.png","sermorelin-5mg",65],
["Super Human Blend 10ml","e76a5f_113167c71c1a4f50839674810e381de8~mv2.png","super-human-blend-10ml",120],
["TB500 10mg","e76a5f_760e2387e716420ea31009664be724a1~mv2.png","tb500-10mg",80],
["TB500 5mg","e76a5f_e8b7bf8f5f2c4ef1bf81d02b11e553d6~mv2.png","tb500-5mg",40],
["Tesamorelin 10mg","e76a5f_7ad307d25c5f4592bce73a9b1e744c59~mv2.png","tesamorelin-10mg",150],
["Thymosin Alpha-1 10mg","e76a5f_06be289fbaec41279797327974781b81~mv2.png","thymosin-alpha-1-10mg",145],
["Thymosin Alpha-1 5mg","e76a5f_a7e640c9a36d42299c9c0af080287887~mv2.png","thymosin-alpha-1-5mg",90],
["Tirzepatide 30mg","e76a5f_2453e0eb191643808c298b6fae046caf~mv2.png","tirzepatide-30mg",400],
...
["Wolverine Stack (BPC-157 10mg + TB500 10mg)","e76a5f_137e78c0ba544faba5e4e62cd33a8699~mv2.png","wolverine-stack-bpc-157-10mg-tb500-10mg",140],
...
+'<div style="display:inline-block;background:#4770db;color:#fff;font-size:11px;font-weight:700;padding:4px 12px;border-radius:20px;letter-spacing:1px;margin:0 0 12px">MOST POPULAR</div>'
+'<h3 style="font-family:Archivo,sans-serif;font-size:20px;font-weight:800;color:#000;margin:0 0 4px">20% Off Every Order</h3>'
...
+'<li style="font-size:13px;color:#000;padding:6px 0;border-bottom:1px solid #e5e7eb">\u2713 20% off every product, every order</li>'
+'<li style="font-size:13px;color:#000;padding:6px 0;border-bottom:1px solid #e5e7eb">\u2713 Priority restock notifications</li>'
+'<li style="font-size:13px;color:#000;padding:6px 0">\u2713 Personal discount code (your initials + 20)</li>'
+'</ul>'
...
+'</div>'
+'<div style="background:#f7f7f8;border-radius:12px;padding:28px 24px;border:1px solid #e5e7eb;overflow:hidden">'
+'<h3 style="font-family:Archivo,sans-serif;font-size:20px;font-weight:800;color:#000;margin:0 0 4px">15% Off Every Order</h3>'
+'<div style="font-size:36px;font-weight:800;color:#000;margin:8px 0">$85<span style="font-size:16px;color:#000">/month</span></div>'
+'<ul style="list-style:none;padding:0;margin:16px 0">'
+'<li style="font-size:13px;color:#000;padding:6px 0;border-bottom:1px solid #e5e7eb">\u2713 15% off all products</li>'
+'<li style="font-size:13px;color:#000;padding:6px 0;border-bottom:1px solid #e5e7eb">\u2713 Protocol consultation included</li>'
+'<li style="font-size:13px;color:#000;padding:6px 0;border-bottom:1px solid #e5e7eb">\u2713 Auto-renews on the 1st</li>'
+'<li style="font-size:13px;color:#000;padding:6px 0">\u2713 Cancel anytime, no commitment</li>'
+'</ul>'
+'<button onclick="window.ppJoinMembership(\'85\')" style="display:block;width:100%;padding:14px;background:#4770db;color:#fff;border:none;border-radius:40px;font-size:16px;font-weight:700;text-align:center;cursor:pointer">Join \u2014 $85/mo</button>'
+'</div>'
+'<div style="background:#f7f7f8;border-radius:12px;padding:28px 24px;border:1px solid #e5e7eb;overflow:hidden">'
+'<h3 style="font-family:Archivo,sans-serif;font-size:20px;font-weight:800;color:#000;margin:0 0 4px">10% Off Every Order</h3>'
+'<div style="font-size:36px;font-weight:800;color:#000;margin:8px 0">$65<span style="font-size:16px;color:#000">/month</span></div>'
+'<ul style="list-style:none;padding:0;margin:16px 0">'
+'<li style="font-size:13px;color:#000;padding:6px 0;border-bottom:1px solid #e5e7eb">\u2713 10% off all products</li>'
+'<li style="font-size:13px;color:#000;padding:6px 0;border-bottom:1px solid #e5e7eb">\u2713 Protocol consultation included</li>'
+'<li style="font-size:13px;color:#000;padding:6px 0;border-bottom:1px solid #e5e7eb">\u2713 Auto-renews on the 1st</li>'
+'<li style="font-size:13px;color:#000;padding:6px 0">\u2713 Cancel anytime, no commitment</li>'
+'</ul>'
+'<button onclick="window.ppJoinMembership(\'65\')" style="display:block;width:100%;padding:14px;background:#4770db;color:#fff;border:none;border-radius:40px;font-size:16px;font-weight:700;text-align:center;cursor:pointer">Join \u2014 $65/mo</button>'
+'</div>'
+'</div>'
...
try{var _pa=localStorage.getItem('pp_applied');if(_pa&&window.ppAffiliate&&ppAffiliate.codes[_pa])ppAffiliate.applied=_pa;}catch(e){}
var _existingCart=document.getElementById('pp-cart-page');if(_existingCart){try{if(window.ppAffiliate&&ppAffiliate.applied&&_existingCart.innerText&&_existingCart.innerText.indexOf(ppAffiliate.applied)===-1){_existingCart.remove();}else{return;}}catch(e){return;}}
var B='https://static.wixstatic.com/media/';
...
window.ppHydrateStoredPromo=function(){try{var pa=localStorage.getItem('pp_applied');if(pa&&window.ppAffiliate&&ppAffiliate.codes[pa]){var cp=document.getElementById('pp-cart-page');var needs=cp&&cp.innerText&&cp.innerText.indexOf(pa)===-1;ppAffiliate.applied=pa;if(needs&&window.ppCartRefresh)ppCartRefresh();}}catch(e){}};
...
(function(){var n=0,t=setInterval(function(){n++;try{if(window.ppHydrateStoredPromo)ppHydrateStoredPromo();}catch(e){}if(n>=8)clearInterval(t);},750);})();
setInterval(function(){try{if(document.getElementById('pp-cart-page')&&window.ppHydrateStoredPromo)ppHydrateStoredPromo();}catch(e){}},500);
...
window.ppCats={
BS:',ghkcu-copper-serum,research-starter-kit,ipamorelin-10mg,aod-9604-10mg,melanotan-ii-10mg,mots-c-10mg,selank-10mg,tb500-10mg,retatrutide-10mg,tesamorelin-10,klow-80mg,',
...
(function(){
var SC='https://www.purefusionpeptide.com/cdn/shop/files/';
var COA_DATA=[
['ARA-290',SC+'Ara_290_purity_COA.png'],
['BPC-157 5mg (Purity)',SC+'BPC_157_5mg_Purity_COA.png'],
['BPC-157 5mg (COA)',SC+'BPC-157_5mg_COA.png'],
['BPC-157 10mg (Purity)',SC+'BPC-157_Purity_COA.png'],
['BPC-157 10mg (COA)',SC+'BPC-157purity_COA_10mg.png'],
['DSIP (Purity)',SC+'DSIP_purity_COA.png'],
['Epitalon',SC+'Epithalon_Purity_COA.png'],
['HGH 6mg',SC+'HGH_Purity_COA.png'],
['HGH 15iu',SC+'HGH_purity_COA_20999870-ce6c-481b-a8e6-d0a492e656ea.png'],
['Ipamorelin 5mg',SC+'Ipamorelin_purity_COA.png'],
['Ipamorelin 10mg',SC+'Ipamorelin_10mg_Purity_COA.png'],
['Kisspeptin',SC+'Kisspeptin_Purity_COA.png'],
['KPV',SC+'KPV_purity_coa.png'],
['L-Glutathione',SC+'L-Glutathione_Purity_COA.png'],
['Melanotan II',SC+'Melatonan_2_Purity_COA.png'],
['NAD+ 500mg (Purity)',SC+'NAD_Purity_COA.png'],
['NAD+ 500mg (COA)',SC+'NADplus_500mg_coa.png'],
['Oxytocin',SC+'Oxytocin_purity_coa.png'],
['PE-22-28',SC+'PE-22-28_purity_coa.png'],
['PT-141',SC+'PT_141_Purity_COA.png'],
['Semax',SC+'Semax_Purity_COA.png'],
['TB-500 5mg',SC+'TB-500_purity_coa_ed18e4e3-1dfc-44c1-824b-e08f31ae9540.png'],
['TB-500 10mg',SC+'TB-500_Purity_COA.png'],
['Tesamorelin 5mg',SC+'TESAMORELIN_Purity_COA.png'],
['Tesamorelin 10mg',SC+'TESAMORELIN_purity_coa_1a601d81-3933-4be6-8d67-7f9ea9615df1.png'],
['Thymosin Alpha-1',SC+'TA-1_purity_coa.png'],
['Wolverine Stack (BPC-157 + TB-500)',SC+'BPC-157_TB_500_wolverine_stack_5mg_Purity_COA.png']
];
